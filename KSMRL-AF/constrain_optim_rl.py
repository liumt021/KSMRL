...
from dataloader import ConstrainOptim_Zink800, DataIterator, PretrainZinkDataset_prop
...
if __name__ == '__main__':
    ...
    if args.reinforce_fintune:PretrainZinkDataset_prop
        # cur_dataloader = DataLoader(ConstrainOptim_Zink800(node_features, adj_features, mol_sizes, all_smiles, all_logps),
        #                             batch_size=args.batch_size,
        #                             shuffle=args.shuffle,
        #                             num_workers=args.num_workers)
        
        cur_dataloader = DataLoader(PretrainZinkDataset_prop(node_features, adj_features, mol_sizes, all_smiles, all_logps),
                                    batch_size=args.batch_size,
                                    shuffle=args.shuffle,
                                    num_workers=args.num_workers)
